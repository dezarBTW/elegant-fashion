  ...
  return (
    <ScrollRevealRoot className={styles.container}>
      ...
      <div className={styles.cardsGrid}>
        <div className={styles.card} data-reveal data-reveal-delay="80">
        ...
        <div className={styles.card} data-reveal data-reveal-delay="160">
          <div className={styles.cardIcon}>
        ...
        <div className={styles.card} data-reveal data-reveal-delay="240">
          <div className={styles.cardIcon}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.card} data-reveal data-reveal-delay="320">
          <div className={styles.cardIcon}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <h3>WhatsApp</h3>
          <a href="https://wa.me/2348166361710" target="_blank" rel="noopener noreferrer" className={styles.cardLink}>
            08166361710
          </a>
        </div>
        ...
        <div className={styles.card} data-reveal data-reveal-delay="80">
          ...
          <h3>Email</h3>
          <a href="mailto:patrickesther26@gmail.com" className={styles.cardLink}>
            patrickesther26@gmail.com
          </a>
        </div>
      </div>
    </ScrollRevealRoot>
